---
name: china-holiday
description: 中国法定节假日查询技能，基于 timor.tech 免费 API。支持查询指定日期节假日信息、批量查询、下一节假日、下一工作日、全年节假日列表，以及语音播报。触发场景：问"今天上班吗"、"明天放假吗"、"2026年有哪些节假日"、"清明节放几天"、"调休怎么调"等节假日相关问题。依赖：Python 3，仅使用标准库（urllib, json, datetime），无需 pip 安装。
---

# 中国节假日查询 (china-holiday)
...
```bash
python3 <skill-path>/scripts/china_holiday.py <命令> [参数]
```
